...
public class Philosopher extends Thread {
	...
	public void walking_to_table(int i)
	{
		try{
			int walking_time = getRandomInteger(10000,1000);
			Thread.sleep(walking_time);
	...
	public void waiting_philo(int i)
	{
		try{
			for (int j=0 ; j<N ; j++)
			{
	...
	public void think (int i)
	{
		state[i]= THINKING;
		try {
			int thinking_time = getRandomInteger(10000,0);
